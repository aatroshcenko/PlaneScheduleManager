...
{
    public class GateOpenedEventHandlerTests
    {
        ...
        private GateOpened CreateGateOpenedEvent(
            Gate gate)
        {
            return new GateOpened(
        ...
        private GateOpenedEventHandler CreateGateOpenedEventHandler(
            ...
            Device device)
        {
            ...
            return new GateOpenedEventHandler(
        ...
        [Fact]
        public void Handle_gate_opened_event_for_connected_device()
        {
        ...
        [Fact]
        public void Handle_gate_opened_event_for_disconnected_device()
        {
            var deviceMessageSenderMock = new Mock<IDeviceMessageSender>();
        ...
        [Fact]
        public void Failed_to_handle_gate_open_event_for_unknown_area()
        {
            var deviceMessageSenderMock = new Mock<IDeviceMessageSender>();
            var gate1 = CreateGate(1, "A");
